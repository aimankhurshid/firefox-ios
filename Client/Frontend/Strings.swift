...
extension String {
    ...
    public struct AppMenu {
        ...
        public static let Zoom = MZLocalizedString("Menu.Zoom", value: "Zoom", comment: "Label for the section, displayed in the menu, that contains the page zoom actions", lastUpdated: .v100)
